...
// left
// #define GA1 LGUI_T(KC_F11)
// #define AA1 LALT_T(KC_F4)
// #define CA1 LCTL_T(KC_F5)
// #define SA1 LSFT_T(KC_F6)
// #define XA1 RALT_T(KC_F1)
...
#define DA1 RALT_T(KC_TRANSPARENT)
...
#define XA2 RALT_T(KC_TRANSPARENT)

// right
// #define SJ2 RSFT_T(KC_DOWN)
// #define CK2 RCTL_T(KC_UP)
// #define AL2 RALT_T(KC_RIGHT)
// #define GQ2 RGUI_T(KC_TRANSPARENT)
// #define DA2 RALT_T(KC_TRANSPARENT)
...
#define DA3 RALT_T(KC_TRANSPARENT)
...
#define DA4 RALT_T(KC_TRANSPARENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO, KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_NO,          KC_NO,   KC_NO,   KC_NO,   DA1,      KC_NO,   KC_NO,
    ...
    KC_NO, KC_NO,   XA2,     KC_NO,   KC_NO,   KC_NO,          KC_HOME, KC_NO,   KC_NO,   KC_NO,    KC_END,  KC_NO,
    ...
    KC_NO, KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE,        KC_NO,   KC_NO,   KC_NO,   DA3,      KC_NO,   KC_NO,
    ...
    KC_NO, KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,         SJ4,     CK4,     AL4,     GQ4,      KC_NO,   KC_NO,

    KC_NO, KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS,        KC_NO,   KC_NO,   KC_NO,   DA4,      KC_NO,   KC_NO,
